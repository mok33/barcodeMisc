...
if __name__ == "__main__":
    ...
    for ic, chunk in enumerate(chunks):
        ...
        outp =  "{}{}_{}_{}_{}_montant_{}_{}_sur_{}_ncarnet_{}.pdf".format(outdir,  "license", os.path.splitext(os.path.basename(args.pdftemplate))[0], args.barcodeprefix, args.gare, args.montant, ic+1, len(chunks), ncarnet)
        if args.carnet25:
