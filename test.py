...
def add_text_to_pdf(template_pdf_path, output_pdf_path, montant='', annee='', gare=''):
    ...
    for idx in range(2):
        ...
        page.insert_text((69, 725-(offset*idx)), f"{montant}", fontname=text_font, fontsize=text_size, color=text_color, rotate=90)
        ...
        page.insert_text((70+233, 750-100-(offset*idx)), f"{montant}", fontname=text_font, fontsize=text_size+8, color=text_color, rotate=90)
